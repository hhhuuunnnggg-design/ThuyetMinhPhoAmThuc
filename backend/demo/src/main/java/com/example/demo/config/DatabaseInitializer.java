...
// private Permission createPermission(String name, String apiPath, String
...
// // Users permissions
// arr.add(createPermission("Xem tất cả danh sách người dùng",
// "/api/v1/users/fetch-all", "GET", "USERS"));
// arr.add(createPermission("Xóa người dùng", "/api/v1/users/{id}", "DELETE",
// "USERS"));
// arr.add(createPermission("thay đổi trạng thái người dùng",
// "/api/v1/users/changeActivity/{id}", "PUT",
// "USERS"));
// arr.add(createPermission("Upload avatar", "/api/v1/users/avatar", "POST",
// "USERS"));
// arr.add(createPermission("Upload cover photo", "/api/v1/users/coverPhoto",
// "POST", "USERS"));
// arr.add(createPermission("Admin tạo người dùng",
// "/api/v1/users/admin/create", "POST", "USERS"));
// arr.add(createPermission("Admin cập nhật người dùng",
// "/api/v1/users/admin/{id}", "PUT", "USERS"));
// arr.add(createPermission("Thêm người dùng", "/api/v1/users/add-user", "POST",
// "USERS"));
// arr.add(createPermission("Cập nhật người dùng", "/api/v1/users/{id}", "PUT",
// "USERS"));

// // Permissions
// arr.add(createPermission("Tạo quyền mới", "/api/v1/permissions/create",
// "POST", "PERMISSIONS"));
// arr.add(createPermission("Cập nhật quyền", "/api/v1/permissions/{id}", "PUT",
// "PERMISSIONS"));
// arr.add(createPermission("Xóa quyền", "/api/v1/permissions/{id}", "DELETE",
// "PERMISSIONS"));
// arr.add(createPermission("Xem danh sách quyền",
// "/api/v1/permissions/fetch-all", "GET", "PERMISSIONS"));

// // Roles
// arr.add(createPermission("Tạo vai trò mới", "/api/v1/roles/create", "POST",
// "ROLES"));
// arr.add(createPermission("Cập nhật vai trò", "/api/v1/roles/{id}", "PUT",
// "ROLES"));
// arr.add(createPermission("Xóa vai trò", "/api/v1/roles/{id}", "DELETE",
// "ROLES"));
// arr.add(createPermission("Xem danh sách vai trò", "/api/v1/roles/fetch-all",
// "GET", "ROLES"));
...
// arr.add(createPermission("Xem danh sách TTS audios", "/api/v1/tts/audios",
// "GET", "TTS"));
// arr.add(createPermission("Xem danh sách TTS audios của mình",
// "/api/v1/tts/audios/my", "GET", "TTS"));
// arr.add(createPermission("Xem TTS audio theo ID", "/api/v1/tts/audios/{id}",
// "GET", "TTS"));
// arr.add(createPermission("Cập nhật TTS audio", "/api/v1/tts/audios/{id}",
// "PUT", "TTS"));
// arr.add(createPermission("Xóa TTS audio", "/api/v1/tts/audios/{id}",
// "DELETE", "TTS"));
...
// arr.add(createPermission("Xem danh sách tất cả groups", "/api/v1/tts/groups",
// "GET", "TTS_GROUPS"));
// arr.add(createPermission("Xem group theo ID", "/api/v1/tts/groups/{id}",
// "GET", "TTS_GROUPS"));
// arr.add(createPermission("Xem group theo groupKey",
// "/api/v1/tts/groups/key/{groupKey}", "GET",
// "TTS_GROUPS"));
// arr.add(createPermission("Xóa group và tất cả audio trong group",
// "/api/v1/tts/groups/{id}", "DELETE",
// "TTS_GROUPS"));
...
// "/api/v1/tts/groups/{id}/generate-multilingual",
// "POST", "TTS_GROUPS"));
...
// "/api/v1/app/narration/check", "POST",
// "APP_CLIENT"));
// arr.add(createPermission("App client - ghi log narration",
// "/api/v1/app/narration/log", "POST",
// "APP_CLIENT"));

// // Narration logs permissions (admin)
// arr.add(createPermission("Xem danh sách narration logs",
// "/api/v1/admin/narration-logs", "GET",
// "NARRATION_LOGS"));

// // POI Admin — SHOP_OWNER có quyền API nhưng backend lọc theo JWT:
// // SUPER_ADMIN / is_admin xem & sửa mọi POI; SHOP_OWNER chỉ POI do user_id
// của
// // họ tạo (POIServiceImpl).
// arr.add(createPermission("Xem danh sách POI (admin)", "/api/v1/admin/pois",
// "GET", "POI_ADMIN"));
// arr.add(createPermission("Xem chi tiết POI (admin)",
// "/api/v1/admin/pois/{id}", "GET", "POI_ADMIN"));
// arr.add(createPermission("Tạo POI (admin)", "/api/v1/admin/pois", "POST",
// "POI_ADMIN"));
// arr.add(createPermission("Cập nhật POI (admin)", "/api/v1/admin/pois/{id}",
// "PUT", "POI_ADMIN"));
// arr.add(createPermission("Xóa POI (admin)", "/api/v1/admin/pois/{id}",
// "DELETE", "POI_ADMIN"));

// // Restaurant Admin permissions
// arr.add(createPermission("Xem danh sách nhà hàng (admin)",
// "/api/v1/admin/restaurants", "GET",
// "RESTAURANT_ADMIN"));
// arr.add(createPermission("Xem chi tiết nhà hàng (admin)",
// "/api/v1/admin/restaurants/{id}", "GET",
// "RESTAURANT_ADMIN"));
// arr.add(createPermission("Tạo nhà hàng (admin)", "/api/v1/admin/restaurants",
// "POST", "RESTAURANT_ADMIN"));
// arr.add(createPermission("Cập nhật nhà hàng (admin)",
// "/api/v1/admin/restaurants/{id}", "PUT",
// "RESTAURANT_ADMIN"));
// arr.add(createPermission("Xóa nhà hàng (admin)",
// "/api/v1/admin/restaurants/{id}", "DELETE",
// "RESTAURANT_ADMIN"));
...
// Role superAdminRole =
// this.roleRepository.findByName("SUPER_ADMIN").orElse(null);
...
// Role shopOwnerRole =
// this.roleRepository.findByName("SHOP_OWNER").orElse(null);
...
// "Chủ quán — POI/TTS/nhà hàng/narration logs: API giống admin nhưng chỉ thấy "
// +
// "dữ liệu gắn POI do chính user đó tạo (user_id trên JWT)");
...
// if (!already) {
// ArrayList<Permission> merged = new
// ArrayList<>(shopOwnerRole.getPermissions());
// merged.add(np);
...
// // SHOP_OWNER thứ hai (B) — dashboard Top POI / real-time chỉ thấy POI do
// chính user này tạo
